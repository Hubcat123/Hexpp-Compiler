...
private:
    const std::string m_pattern_strings[PatternType::num_patterns] = {
        ...
        "Assessor's Purification", "Assessor's Reflection", "Aviator's Purification", "Axial Purification", "Black Sun's Nadir", "Black Sun's Zenith", "Blue Sun's Nadir",
        "Blue Sun's Zenith", "Bookkeeper's Gambit", "Break Block", "Ceiling Purification", "Charon's Gambit", "Chronicler's Gambit", "Chronicler's Purification", "Circle's Reflection",
        ...
        "Derivation Decomposition", "Dioscuri Gambit", "Disjunction Distillation", "Division Distillation", "Dispel Rain", "Entropy Reflection", "Euler's Reflection",
        "Equality Distillation", "Evanition", "Excisors Distillation", "Explosion", "False Reflection", "Fireball", "Fisherman's Gambit", "Fisherman's Gambit II",
        "Flock's Disintegration", "Flock's Gambit", "Flock's Reflection", "Floor Purification", "Gemini Decomposition", "Gemini Gambit", "Greater Fold Reflection", "Hermes' Gambit",
        ...
        "Numerical Reflection", "Pace Purification", "Power Distillation", "Prospector's Gambit", "Retrograde Purification", "Retrospection", "Reveal", "Rotation Gambit", "Rotation Gambit II",
