...
enum class TokenType_ {
    ...
    vec, self, pos, mine, print, pow, eye_pos, forward, block_raycast, block_normal_raycast, create_light, create_water, block_raycast_from, block_normal_raycast_from, add, size, find,
    stack_size, dump_stack
};
